 ...
 * generated in the es.mityc.facturae32 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.mityc.facturae32
     * 
     */

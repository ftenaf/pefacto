 ...
 *       &lt;sequence>
 *         &lt;element name="SchemaVersion" type="{http://www.facturae.es/Facturae/2007/v3.0/Facturae}SchemaVersionType"/>
 *         &lt;element name="Modality" type="{http://www.facturae.es/Facturae/2007/v3.0/Facturae}ModalityType"/>
 *         &lt;element name="InvoiceIssuerType" type="{http://www.facturae.es/Facturae/2007/v3.0/Facturae}InvoiceIssuerTypeType"/>
 *         &lt;element name="ThirdParty" type="{http://www.facturae.es/Facturae/2007/v3.0/Facturae}ThirdPartyType" minOccurs="0"/>
 *         &lt;element name="Batch" type="{http://www.facturae.es/Facturae/2007/v3.0/Facturae}BatchType"/>
 *         &lt;element name="FactoringAssignmentData" type="{http://www.facturae.es/Facturae/2007/v3.0/Facturae}FactoringAssignmentDataType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FileHeaderType {
    ...
    @XmlElement(name = "SchemaVersion", required = true, defaultValue = "3.0")

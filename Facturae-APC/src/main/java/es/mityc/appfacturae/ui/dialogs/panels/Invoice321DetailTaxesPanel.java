...
import es.mityc.appfacturae.ui.beans.TaxOutputView;
...
public class Invoice321DetailTaxesPanel extends JPanel implements InvoiceDetailTaxesPanel {

	private Properties decimalProps = null;
	private Boolean specialBaseRequired;

	public Invoice321DetailTaxesPanel(Boolean specialBaseRequired) {
		super();
	...
	private void initComponents() {
		...
		jComboBoxSpecial.addPopupMenuListener(new PopupMenuListener() {
			public void popupMenuCanceled(PopupMenuEvent evt) {
				((Invoice321DetailDialog) jComboBoxSpecial.getTopLevelAncestor()).getFadingCanvas().setVisible(true);
			}
			...
			public void popupMenuWillBecomeVisible(PopupMenuEvent evt) {
				((Invoice321DetailDialog) jComboBoxSpecial.getTopLevelAncestor()).getFadingCanvas().setVisible(false);
		...
		this.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(
			Constants.SELECTION_COLOR, 1, true), Constants.LANG.getString("Taxes"),
		...
		jTableTOutputs.setModel(new javax.swing.table.DefaultTableModel(
			new Object[][] {}, 
			new String[] {
				Constants.LANG.getString("Tax"),
				Constants.LANG.getString("TaxType"),
				Constants.LANG.getString("TB"),
				Constants.LANG.getString("TaxAmountLC") + " (" + Constants.LANG.getString("EuroSimbol") + ")",
				Constants.LANG.getString("SpecialTaxableBase"),
				Constants.LANG.getString("SpecialTaxAmount") + " (" + Constants.LANG.getString("EuroSimbol") + ")",
				Constants.LANG.getString("EquivalenceSurcharge"),
				Constants.LANG.getString("EquivalenceSurchargeAmount") + " (" + Constants.LANG.getString("EuroSimbol")+ ")" 
			}) {
		...
		jTableTOutputs.getColumnModel().getColumn(0).setCellRenderer(
		...
		jTableTOutputs.getColumnModel().getColumn(1).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
		...
		jTableTOutputs.getColumnModel().getColumn(2).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.RIGHT));
		jTableTOutputs.getColumnModel().getColumn(3).setResizable(false);
		jTableTOutputs.getColumnModel().getColumn(3).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.RIGHT));
		jTableTOutputs.getColumnModel().getColumn(4).setResizable(false);
		jTableTOutputs.getColumnModel().getColumn(4).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.RIGHT));
		jTableTOutputs.getColumnModel().getColumn(5).setResizable(false);
		jTableTOutputs.getColumnModel().getColumn(5).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.RIGHT));
		jTableTOutputs.getColumnModel().getColumn(6).setResizable(false);
		jTableTOutputs.getColumnModel().getColumn(6).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.RIGHT));
		jTableTOutputs.getColumnModel().getColumn(7).setResizable(false);
		jTableTOutputs.getColumnModel().getColumn(7).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.RIGHT));
		...
		jButtonTDelOutput.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				Invoice321DetailTaxesPanel.this.mouseEntered(evt);
			}

			public void mouseExited(java.awt.event.MouseEvent evt) {
				Invoice321DetailTaxesPanel.this.mouseExited(evt);
			}
		});
		...
		jPanelTOutputsLayout.setHorizontalGroup(jPanelTOutputsLayout.createParallelGroup(
			org.jdesktop.layout.GroupLayout.LEADING).add(
			jPanelTOutputsLayout.createSequentialGroup().addContainerGap()
				.add(jScrollPaneTOutputs, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 719,
				...
				.add(20, 20, 20)));
		jPanelTOutputsLayout.setVerticalGroup(jPanelTOutputsLayout.createParallelGroup(
			org.jdesktop.layout.GroupLayout.LEADING).add(
			jPanelTOutputsLayout.createSequentialGroup()
				.add(jPanelTOutputsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
						.add(org.jdesktop.layout.GroupLayout.LEADING,jPanelTOutputsLayout.createSequentialGroup()
								.add(18, 18, 18)
								.add(jButtonTAddOutput, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 22,
									org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(jButtonTDelOutput, 0, 0, Short.MAX_VALUE))
						.add(org.jdesktop.layout.GroupLayout.LEADING,jPanelTOutputsLayout
								.createSequentialGroup()
								.addContainerGap()
								.add(jScrollPaneTOutputs, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 65,
									org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
		...
		jTableTWithhelds.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] {}, 
				new String[] { 
						Constants.LANG.getString("TaxType"), Constants.LANG.getString("Rate"),
		...
		jTableTWithhelds.getColumnModel().getColumn(0).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.LEFT));
		jTableTWithhelds.getColumnModel().getColumn(1).setResizable(false);
		jTableTWithhelds.getColumnModel().getColumn(1).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.RIGHT));
		jTableTWithhelds.getColumnModel().getColumn(2).setResizable(false);
		jTableTWithhelds.getColumnModel().getColumn(2).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.RIGHT));
		jTableTWithhelds.getColumnModel().getColumn(3).setResizable(false);
		jTableTWithhelds.getColumnModel().getColumn(3).setCellRenderer(
				new CustomCellRenderer(Constants.SELECTION_COLOR, java.awt.Color.white, Constants.FONT_COLOR,
					Constants.FONT_COLOR, Constants.FONT_PLAIN, javax.swing.SwingConstants.RIGHT));
		...
		jPanelTWithheldsLayout.setHorizontalGroup(jPanelTWithheldsLayout.createParallelGroup(
			org.jdesktop.layout.GroupLayout.LEADING).add(
			jPanelTWithheldsLayout.createSequentialGroup()
				.add(99, 99, 99)
				.add(jScrollPaneTWithhelds, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 538,
					org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
				.add(40, 40, 40)
				...
				.add(93, 93, 93)));
		jPanelTWithheldsLayout.setVerticalGroup(jPanelTWithheldsLayout.createParallelGroup(
			org.jdesktop.layout.GroupLayout.LEADING).add(
			jPanelTWithheldsLayout.createSequentialGroup().addContainerGap()
				.add(jPanelTWithheldsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
						.add(org.jdesktop.layout.GroupLayout.LEADING,jPanelTWithheldsLayout.createSequentialGroup()
								.add(10, 10, 10)
								.add(jButtonTAddWithheld, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 22,
									org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(4, 4, 4)
								.add(jButtonTDelWithheld, 0, 0, Short.MAX_VALUE))
						.add(4, 4, 4)
						.add(jScrollPaneTWithhelds, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 65,
		...
		jPanelMainLayout.setHorizontalGroup(jPanelMainLayout.createParallelGroup(
			org.jdesktop.layout.GroupLayout.LEADING).add(
			jPanelMainLayout.createSequentialGroup().addContainerGap()
				.add(jPanelMainLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						...
						.add(jPanelMainLayout.createSequentialGroup()
								...
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(jComboBoxSpecial, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 150,
									org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(10, 10, 10)
								.add(jSpecialEventReason)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(jTextFieldSpecial, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 300,
									Short.MAX_VALUE))).addContainerGap()));
		jPanelMainLayout.setVerticalGroup(jPanelMainLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
			.add(jPanelMainLayout.createSequentialGroup()
					.addContainerGap()
					.add(jTabbedPaneT, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 110,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
					.add(jPanelMainLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER).add(jSpecialEvent)
							.add(jSpecialEventCode).add(jComboBoxSpecial).add(jSpecialEventReason)
							.add(jTextFieldSpecial)).addContainerGap()));
		...
		try {
			...
			((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
				Constants.LANG.getString("MainWindowException1"), Constants.ERROR_MSG_COLOR);
		}
	}
	...
	private void addOutput(java.awt.event.ActionEvent evt) {
		...
		String tibString = ((Invoice321DetailDialog) this.getTopLevelAncestor()).jPanelGeneral.getJTextFieldGGROSS()
			.getText().trim();
		Double tib = null;
		if (tibString != null && !"".equals(tibString)) {
			try {
				tib = DoubleUtil.getDoubleFromPrettyNumber(tibString);
				tib = DoubleUtil.roundWithPrecisionDouble(tib, Integer.parseInt(decimalProps.getProperty("item_taxable_base")));
		...
		if (tib == null) {
			((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
				Constants.LANG.getString("NOOKParamTaxItemRequired"), Constants.ERROR_MSG_COLOR);
			return;
		}
		InputTaxesOutputsDialog itod = new InputTaxesOutputsDialog(null, true, tib, specialBaseRequired, Constants.VERSION321);
		...
		TaxOutputView filaActual = null;
		TaxOutputView filaNueva = TaxOutputView.getElementFromResult(result); //result
		// Recorremos las filas de impuestos repercutidos que ya están cargadas en la tabla
		for (int i = 0; i < outputsModel.getRowCount(); ++i) {
			filaActual = TaxOutputView.getElementFromTable(outputsModel,i); //outputModel
			if (filaActual.getIdImpuesto().equals(filaNueva.getIdImpuesto())
					&& new Double(filaActual.getTipoImpositivo()).doubleValue() == new Double(filaNueva.getTipoImpositivo()).doubleValue()) {
				if (filaActual.getRecargoEquivalencia().isEmpty() && filaNueva.getRecargoEquivalencia().isEmpty()) {
					((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
							Constants.LANG.getString("OKMessageTaxAlreadyExists"), Constants.OK_MSG_COLOR);
					return;
				} else if (! (filaActual.getRecargoEquivalencia().isEmpty() && !filaNueva.getRecargoEquivalencia().isEmpty())) {
					if (! (!filaActual.getRecargoEquivalencia().isEmpty() && filaNueva.getRecargoEquivalencia().isEmpty())) {
						if (new Double(filaActual.getRecargoEquivalencia()).doubleValue() == new Double(filaNueva.getRecargoEquivalencia()).doubleValue()) {
				 			((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
								Constants.LANG.getString("OKMessageTaxAlreadyExists"), Constants.OK_MSG_COLOR);
				 			return;
						}
			...
			if (DoubleUtil.getDoubleFromPrettyNumber(filaActual.getCuota()) >= 0) {
				// The other negative taxes may be equals
				if (filaNueva.getCuota() != null && DoubleUtil.getDoubleFromPrettyNumber(filaNueva.getCuota()) < 0) {
					boolean flag = false;
					// Tax type
					if ((filaNueva.getIdImpuesto() != null && !filaNueva.getIdImpuesto().equals(filaActual.getIdImpuesto()))
						|| (filaNueva.getIdImpuesto() == null && filaActual.getIdImpuesto() != null))
						flag = true;
					// Tax rate
					if ((filaNueva.getTipoImpositivo() != null && new Double(filaNueva.getTipoImpositivo()).doubleValue() != new Double(filaActual.getTipoImpositivo()).doubleValue())
						|| (filaNueva.getTipoImpositivo()== null && filaActual.getTipoImpositivo() != null))
						flag = true;
					// Charge amount
					if ((filaNueva.getCuota() != null && new Double(filaNueva.getCuota()).doubleValue() != new Double(filaActual.getCuota()).doubleValue())
						|| (filaNueva.getCuota() == null && filaActual.getCuota() != null))
						flag = true;
					if (flag) {
						((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
							Constants.LANG.getString("NOOKMessageTaxNegativeNotEquals"), Constants.ERROR_MSG_COLOR);
						return;
					}
				}
			} else if (filaActual.getCuota() != null
				&& DoubleUtil.getDoubleFromPrettyNumber(filaActual.getCuota()) < 0) { // If item have a negative OutputTax...
				if (filaNueva.getCuota() != null && DoubleUtil.getDoubleFromPrettyNumber(filaNueva.getCuota()) > 0) {
		...
		if (filaNueva.getBaseImponibleEspecial() != null && !"".equals(filaNueva.getBaseImponibleEspecial().trim()))
		...
		((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
			Constants.LANG.getString("OKMessageTaxOutPutAdded"), Constants.OK_MSG_COLOR);
	}
	...
	private void delOutput(java.awt.event.ActionEvent evt) {
		...
		if (row >= 0) {
			...
			((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
				Constants.LANG.getString("OKMessageTaxOutPutDeleted"), Constants.OK_MSG_COLOR);
			if (jTableTOutputs.getModel().getRowCount() == 0)
				specialBaseRequired = ((Invoice321DetailDialog) this.getTopLevelAncestor()).specialBaseRequired;
		} else
			((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
	...
	private void addWithheld(java.awt.event.ActionEvent evt) {
		...
		InputTaxesWithheldDialog itod = new InputTaxesWithheldDialog(null, true, tib, Constants.VERSION321);
		itod.setVisible(true);
		String[] result = itod.getValues();
		// Check if tax already exists
		TableModel withHeldModel = jTableTWithhelds.getModel();
		for (int i = 0; i < withHeldModel.getRowCount(); ++i) {
			if (withHeldModel.getValueAt(i, 0).toString().equals(result[0])
				&& withHeldModel.getValueAt(i, 1).toString().equals(result[1])) {
				((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
					Constants.LANG.getString("OKMessageTaxAlreadyExists"), Constants.OK_MSG_COLOR);
				return;
			}
		...
		((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
			Constants.LANG.getString("OKMessageTaxWithHeldAdded"), Constants.OK_MSG_COLOR);
	}
	...
	private void delWithheld(java.awt.event.ActionEvent evt) {
		...
		if (row >= 0) {
			...
			((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
				Constants.LANG.getString("OKMessageTaxWithHeldDeleted"), Constants.OK_MSG_COLOR);
		} else
			((Invoice321DetailDialog) this.getTopLevelAncestor()).showMessage(
				Constants.LANG.getString("NOOKForDeleteMessage"), Constants.ERROR_MSG_COLOR);
	}
	...
	public void grossAmountChanged() {
		Double total = DoubleUtil.roundWithPrecisionDouble(DoubleUtil.getDoubleFromPrettyNumber(((Invoice321DetailDialog) jTableTOutputs
			.getTopLevelAncestor()).jPanelGeneral.getJTextFieldGGROSS().getText()), Integer.parseInt(decimalProps
			.getProperty("item_taxable_base")));
		String value = null;
		Double d = 0.00;
		...
		for (int i = 0; i < modelO.getRowCount(); ++i) {
			...
			// d = (d * total) / 100;
			// d = DoubleUtil.roundWithPrecisionDouble(d, Integer
			// .parseInt(decimalProps.getProperty("item_tax_Out")));
			...
			if (value == null || "".equals(value.trim())) {
				...
				if (modelO.getValueAt(i, 6) != null) {
					...
					if (value != null && !"".equals(value.trim())) {
						d = DoubleUtil.getDoubleFromPrettyNumber(value);
						d = (d * total) / 100;
						d = DoubleUtil.roundWithPrecisionDouble(d, Integer.parseInt(decimalProps.getProperty("special_taxable_amount")));
		...
		for (int i = 0; i < modelW.getRowCount(); ++i) {
			...
			if (value != null && !"".equals(value.trim())) {
				d = DoubleUtil.getDoubleFromPrettyNumber(value);
				d = (d * total) / 100;
				d = DoubleUtil.roundWithPrecisionDouble(d, Integer.parseInt(decimalProps.getProperty("item_tax_With")));

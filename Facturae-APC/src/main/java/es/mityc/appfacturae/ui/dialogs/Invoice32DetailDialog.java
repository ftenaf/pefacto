...
import es.mityc.appfacturae.facturae32.DeliveryNoteType;
import es.mityc.appfacturae.facturae32.InvoiceLineType;
import es.mityc.appfacturae.facturae32.SpecialTaxableEventType;
...
import es.mityc.appfacturae.ui.dialogs.panels.Invoice32DetailTaxesPanel;
...
public class Invoice32DetailDialog extends javax.swing.JDialog implements InvoiceDetailDialog{
    ...
    private static Log logger = LogFactory.getLog(Invoice32DetailDialog.class);
	public Boolean specialBaseRequired;
    
    /** Creates new form InvoiceDetailFrame */
    public Invoice32DetailDialog(Frame parent, boolean modal, Boolean specialBaseRequired, boolean setDisabled) {
    	super(parent, modal);
    ...
    private void initComponents() {
        ...
        jPanelGeneral = new InvoiceDetailGeneralPanel(Constants.VERSION32);
        jPanelTaxes = new Invoice32DetailTaxesPanel(specialBaseRequired);
        ...
        jButtonAccept.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	...
            	if ( jPanelGeneral.getJButtonXMLAddDataZoom().getIcon().toString().contains("button_mini_zoom_error.jpg") ) {
				...
				if ( jPanelGeneral.getJComboBoxGDesc().getSelectedItem() == null || 
					...
					jPanelGeneral.getJComboBoxGDesc().getEditor().getEditorComponent().setBackground(Constants.BKG_ERROR_COLOR);
				}
				...
				if (jPanelTaxes.getJComboBoxSpecial().getSelectedIndex() > 0 && (jPanelTaxes.getJTextFieldSpecial() == null || jPanelTaxes.getJTextFieldSpecial().getText() == null || "".equals(jPanelTaxes.getJTextFieldSpecial().getText().trim()))){
					flag = true;
				...
				if (flag)
					...
					if (jPanelTaxes.getJTableTOutputs().getRowCount() == 0){
						if (jPanelTaxes.getJComboBoxSpecial().getSelectedIndex() > 0)
							((javax.swing.table.DefaultTableModel)jPanelTaxes.getJTableTOutputs().getModel()).addRow(new String[]{Constants.LANG.getString("VATTax")+" - 01", "0.00", "0.00", "0.00", "", "", "", ""});
						else {
							fd.showMessage(Constants.LANG.getString("NOOKParamTaxOutputRequired"), Constants.ERROR_MSG_COLOR);
							return;
						}
	            	}
					String value1 = "";
					...
					for (int i = 1 ; i < outputsRows; i++){
						...
						if (!value1.equals(value2)){
							fd.showMessage(Constants.LANG.getString("NOOKDifferentSpecialTaxableBases"), Constants.ERROR_MSG_COLOR);
		            		return;
						}	
						else{
							value1 = value2;
        ...
        jButtonAccept.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
            	Invoice32DetailDialog.this.mouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
            	Invoice32DetailDialog.this.mouseExited(evt);
            }
        });
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel9Layout.createSequentialGroup()
                .add(jLabelTopBarImage, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 404, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 47, Short.MAX_VALUE)
                .add(jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(jLabelTopBarMsg2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanelMainLayout.setHorizontalGroup(
            ...
            .add(jPanelMainLayout.createSequentialGroup()
                ...
                .add(jPanelMainLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanelTaxes, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanelMainLayout.createSequentialGroup()
                        .add(jPanelGeneral, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jPanelOtherData, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE))
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanelMainLayout.createSequentialGroup()
                        .add(jButtonAccept)
                        .add(50, 50, 50)
                        .add(jButtonCancel)
                        ...
                        .add(20,20,20)
                        .add(jButtonHelp, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 37, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanelMainLayout.setVerticalGroup(
            ...
            .add(jPanelMainLayout.createSequentialGroup()
                ...
                .add(jPanelMainLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanelGeneral, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelTaxes, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
//              .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelMainLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                    .add(jButtonAccept)
                    .add(jButtonCancel)
                    .add(fd)
                    .add(jButtonHelp, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 34, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .add(mainPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 865, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(mainPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 576, Short.MAX_VALUE)
        );
    ...
    public InvoiceLineType getValues() {
    	...
    	if (desc == null || "".equals(desc.trim()) || 
    		quantity == null || "".equals(quantity.trim()) || 
    ...
    // General panel
	    ...
	    result.setGrossAmount(DoubleUtil.round(DoubleUtil.getDoubleFromPrettyNumber(jPanelGeneral.getJTextFieldGGROSS().getText()), Integer.parseInt(decimalProps.getProperty("item_gross_cost")) ));
	    // 3.1.6.1.19 Aditional Information
	    result.setAdditionalLineItemInformation(jPanelGeneral.getJTextAreaGAddInfo().getText());
	    // 3.1.6.20 Extensions
		if (jPanelGeneral.getJTextAreaXMLExtAddData().getText() != null && !"".equals(jPanelGeneral.getJTextAreaXMLExtAddData().getText().trim())){
	    ...
	    for (int i = 0;i < discountSize; ++i) {
	    	...
	    	DiscountType discount = new DiscountType();
	    		...
	    		discount.setDiscountAmount(DoubleUtil.getDoubleFromPrettyNumber(jPanelGeneral.getJTableGDiscounts().getModel().getValueAt(i, 2).toString()));
   	...
   	// Other data panel
		...
		XMLGregorianCalendar issuerContractDate = Invoice32DetailDialog.getDateFromCombo(jPanelOtherData.getJCalendarComboBoxOIssC());
		...
		XMLGregorianCalendar issuerTransactionDate = Invoice32DetailDialog.getDateFromCombo(jPanelOtherData.getJCalendarComboBoxOIssO());;
		...
		XMLGregorianCalendar receiverContractDate = Invoice32DetailDialog.getDateFromCombo(jPanelOtherData.getJCalendarComboBoxORecC());;
		...
		XMLGregorianCalendar receiverTransactionDate = Invoice32DetailDialog.getDateFromCombo(jPanelOtherData.getJCalendarComboBoxORecO());;
		...
		// 3.1.6.1.10 FileDate
		XMLGregorianCalendar fileDate = Invoice32DetailDialog.getDateFromCombo(jPanelOtherData.getJCalendarComboBoxOFile());;
		...
		for(int i = 0; i < deliverySize; ++i) {
			...
			deliveryNote.setDeliveryNoteNumber(jPanelOtherData.getJTableODelivery().getModel().getValueAt(i, 0).toString());
			// 3.1.6.1.12.1.2 DeliveryNoteDate
			XMLGregorianCalendar deliveryNoteDate = null;
			if (jPanelOtherData.getJTableODelivery().getModel().getValueAt(i, 1) != null && !"".equals(jPanelOtherData.getJTableODelivery().getModel().getValueAt(i, 1).toString().trim())){
				try {
					DatatypeFactory df;
					df = DatatypeFactory.newInstance();
					deliveryNoteDate = df.newXMLGregorianCalendar();
					GregorianCalendar calendar = new GregorianCalendar();
					calendar.setTime(Constants.DATE_FORMAT.parse(jPanelOtherData.getJTableODelivery().getModel().getValueAt(i, 1).toString()));
					...
					logger.error("Error getting invoice line data while creating a XMLGregorianCalendar:" + e.getMessage());
					return null;
    ...
    // Tax panel
		...
		for (int i = 0; i < outputsSize; i++) {
			...
			InvoiceLineType.TaxesOutputs.Tax taxOut = new InvoiceLineType.TaxesOutputs.Tax();	
					...
					if (modelO.getValueAt(i, 4) != null && 
						!"".equals(modelO.getValueAt(i, 4).toString().trim())) {
		...
		if (jPanelTaxes.getJComboBoxSpecial().getSelectedItem() != null && !"".equals(jPanelTaxes.getJComboBoxSpecial().getSelectedItem().toString())){
			SpecialTaxableEventType specialTaxableEvent = new SpecialTaxableEventType();
			// 3.1.6.1.26.1 SpecialTaxableEventCode
			specialTaxableEvent.setSpecialTaxableEventCode(IntegerUtil.to2String(jPanelTaxes.getJComboBoxSpecial().getSelectedIndex()));
    ...
    public void setValues(InvoiceLineType ilt) {
      ...
      // General panel
    	...
    	if (quantity != null)
    		jPanelGeneral.getJTextFieldGQuantity().setText(quantity.toString());
    	...
    	// 3.1.6.1.10 UnitPriceWithoutTax
      	...
      	if(unitPriceWithoutTax != null)
      		jPanelGeneral.getJTextFieldGUnitPrice().setText(unitPriceWithoutTax.toString());
      	
      	// 3.1.6.1.11 TotalCost
      	Double totalCost = ilt.getTotalCost();
      	if(totalCost != null)
      		jPanelGeneral.getJTextFieldGTotAmount().setText(totalCost.toString());
      	
      	// 3.1.6.1.14 GrossAmount
      	Double grossAmount = ilt.getGrossAmount();
      	if(grossAmount != null)
      		jPanelGeneral.getJTextFieldGGROSS().setText(grossAmount.toString());
      	...
      	if (ilt.getDiscountsAndRebates() != null) {
      		...
      		for(int i = 0; i < discountSize; i++){
      			...
      			if(ilt.getDiscountsAndRebates().getDiscount().get(i).getDiscountRate() != null)
      				ob[1] = ilt.getDiscountsAndRebates().getDiscount().get(i).getDiscountRate();
     ...
     // Other data panel
    	...
    	if (ilt.getIssuerTransactionDate() != null){
    		jPanelOtherData.getJCalendarComboBoxOIssO().setCalendar(ilt.getIssuerTransactionDate().toGregorianCalendar());
    	...
    	if (ilt.getReceiverContractDate() != null){
    		jPanelOtherData.getJCalendarComboBoxORecC().setCalendar(ilt.getReceiverContractDate().toGregorianCalendar());
    	...
    	if (ilt.getReceiverTransactionDate() != null){
    		jPanelOtherData.getJCalendarComboBoxORecO().setCalendar(ilt.getReceiverTransactionDate().toGregorianCalendar());
    	...
    	if (ilt.getDeliveryNotesReferences() != null) {
    		...
    		for(int i = 0; i < deliverySize; i++) {
    			...
    			String deliveryNoteNumber = ilt.getDeliveryNotesReferences().getDeliveryNote().get(i).getDeliveryNoteNumber();
    			XMLGregorianCalendar deliveryNoteDate = ((es.mityc.appfacturae.facturae32.DeliveryNoteType)ilt.getDeliveryNotesReferences().getDeliveryNote().get(i)).getDeliveryNoteDate();
     ...
     // Tax panel
		...
		for(int i = 0; i < outputsSize; i++){
			...
			if(ilt.getTaxesOutputs().getTax().get(i).getTaxAmount() != null){
      		...
      		if(ilt.getTaxesOutputs().getTax().get(i).getSpecialTaxableBase() != null){
      			Double specialTaxableBase = ilt.getTaxesOutputs().getTax().get(i).getSpecialTaxableBase().getTotalAmount();
      		...
      		if(ilt.getTaxesOutputs().getTax().get(i).getEquivalenceSurchargeAmount() != null){
      			Double equivalenceSurchargeAmount = ilt.getTaxesOutputs().getTax().get(i).getEquivalenceSurchargeAmount().getTotalAmount();
		...
		if (ilt.getSpecialTaxableEvent() != null){
			if (!"".equals(ilt.getSpecialTaxableEvent().getSpecialTaxableEventCode()))
				jPanelTaxes.getJComboBoxSpecial().setSelectedIndex(Integer.parseInt(ilt.getSpecialTaxableEvent().getSpecialTaxableEventCode()));
    ...
    private void setFieldsDisabled() {
		...
		jPanelGeneral.getJButtonXMLAddData().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_accept_disabled.jpg")));    	
    	jPanelGeneral.getJButtonXMLAddDataZoom().setEnabled(false);
    	jPanelGeneral.getJButtonXMLAddDataZoom().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_zoom_disabled.jpg")));
    	jPanelGeneral.getJButtonGAddCharge().setEnabled(false);
    	jPanelGeneral.getJButtonGAddCharge().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_plus_disabled.jpg")));
    	jPanelGeneral.getJButtonGAddDiscount().setEnabled(false);
    	jPanelGeneral.getJButtonGAddDiscount().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_plus_disabled.jpg")));
    	jPanelGeneral.getJButtonGDelCharge().setEnabled(false);
    	jPanelGeneral.getJButtonGDelCharge().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_minus_disabled.jpg")));
    	jPanelGeneral.getJButtonGDelDiscount().setEnabled(false);
    	jPanelGeneral.getJButtonGDelDiscount().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_minus_disabled.jpg")));
    	...
    	jPanelOtherData.getJButtonOAddDelivery().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_plus_disabled.jpg")));
    	jPanelOtherData.getJButtonODelDelivery().setEnabled(false);
    	jPanelOtherData.getJButtonODelDelivery().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_minus_disabled.jpg")));
    	...
    	jPanelTaxes.getJButtonTAddOutput().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_plus_disabled.jpg")));
    	jPanelTaxes.getJButtonTDelOutput().setEnabled(false);
    	jPanelTaxes.getJButtonTDelOutput().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_minus_disabled.jpg")));
    	jPanelTaxes.getJButtonTAddWithheld().setEnabled(false);
    	jPanelTaxes.getJButtonTAddWithheld().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_plus_disabled.jpg")));
    	jPanelTaxes.getJButtonTDelWithheld().setEnabled(false);
    	jPanelTaxes.getJButtonTDelWithheld().setDisabledIcon(new ImageIcon(jPanelGeneral.getClass().getResource("/images/button_mini_minus_disabled.jpg")));
    ...
    private void jButtonHelpActionPerformed() {
    	URL helpFile = this.getClass().getResource("/html/help_InvoiceDetailDialog_"+Constants.LANG.getLocale().getLanguage()+".html");
    	if (helpFile == null) {
    ...
    public Invoice32DetailTaxesPanel jPanelTaxes = null;
    // JButton

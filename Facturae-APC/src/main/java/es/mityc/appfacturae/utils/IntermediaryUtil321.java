...
public class IntermediaryUtil321 {

	/**
	 * Converts an es.mityc.facturae321.Facturae object into an es.mityc.appfacturae.facturae.Facturae object  ***
	 * @param facturae The es.mityc.facturae321.Facturae object to convert
	 * @return The es.mityc.appfacturae.facturae.Facturae object
	 */
	public static es.mityc.appfacturae.facturae.Facturae getApplicationFacturae(es.mityc.facturae321.Facturae facturae) {
		...
		if (facturae.getFileHeader().getFactoringAssignmentData() != null) {
			es.mityc.appfacturae.facturae321.FactoringAssignmentDataType factoringAssignmentData = new es.mityc.appfacturae.facturae321.FactoringAssignmentDataType();
			...
			es.mityc.appfacturae.facturae321.InstallmentType installment2 = null;
			...
			for (int j = 0; j < installmentCount2; j++) {
				...
				installment2 = new es.mityc.appfacturae.facturae321.InstallmentType();
				...
				if (facturae.getFileHeader().getFactoringAssignmentData().getPaymentDetails().getInstallment().get(j)
					...
					es.mityc.appfacturae.facturae321.AccountType accountToBeCredited = new es.mityc.appfacturae.facturae321.AccountType();
				...
				if (facturae.getFileHeader().getFactoringAssignmentData().getPaymentDetails().getInstallment().get(j)
					...
					es.mityc.appfacturae.facturae321.AccountType accountToBeDebited = new es.mityc.appfacturae.facturae321.AccountType();
			...
			((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) factoringAssignmentData)
		...
		if (facturae.getParties().getSellerParty().getAdministrativeCentres() != null
			...
			es.mityc.appfacturae.facturae321.AdministrativeCentreType administrativeCentre = null;
			...
			for (int i = 0; i < adminCentresCount; i++) {
				...
				administrativeCentre = new es.mityc.appfacturae.facturae321.AdministrativeCentreType();
		...
		if (facturae.getParties().getBuyerParty().getAdministrativeCentres() != null
			...
			es.mityc.appfacturae.facturae321.AdministrativeCentreType administrativeCentre2 = null;

			int adminCentresCount = facturae.getParties().getBuyerParty().getAdministrativeCentres()
				.getAdministrativeCentre().size();
			for (int i = 0; i < adminCentresCount; i++) {

				administrativeCentre2 = new es.mityc.appfacturae.facturae321.AdministrativeCentreType();
		...
		// 3.1 Invoice
		es.mityc.appfacturae.facturae321.InvoiceType invoiceType = null;

		// for 1
		int invoicesCount2 = facturae.getInvoices().getInvoice().size();
		for (int i = 0; i < invoicesCount2; i++) {

			invoiceType = new es.mityc.appfacturae.facturae321.InvoiceType();
			...
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceHeader().getCorrective() != null) {
				es.mityc.appfacturae.facturae321.CorrectiveType corrective = new es.mityc.appfacturae.facturae321.CorrectiveType();
			...
			es.mityc.appfacturae.facturae321.InvoiceIssueDataType invoiceIssueData = new es.mityc.appfacturae.facturae321.InvoiceIssueDataType();
			...
			// 3.1.3 TaxesOutputs
			es.mityc.appfacturae.facturae321.InvoiceType.TaxesOutputs taxesOutputs = new es.mityc.appfacturae.facturae321.InvoiceType.TaxesOutputs();

			// 3.1.3.1 Tax
			es.mityc.appfacturae.facturae321.TaxOutputType tax = null;

			// for 2	
			int taxCount = facturae.getInvoices().getInvoice().get(i).getTaxesOutputs().getTax().size();
			for (int j = 0; j < taxCount; j++) {
				tax = new es.mityc.appfacturae.facturae321.TaxOutputType();
			...
			// 3.1.5 InvoiceTotals
			es.mityc.appfacturae.facturae321.InvoiceTotalsType invoiceTotals = new es.mityc.appfacturae.facturae321.InvoiceTotalsType();
			...
			// 3.1.6.1 InvoiceLine
			es.mityc.appfacturae.facturae321.InvoiceLineType invoiceLine = null;

			// for 8
			int invoiceLineCount = facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().size();
			for (int j = 0; j < invoiceLineCount; j++) {

				invoiceLine = new es.mityc.appfacturae.facturae321.InvoiceLineType();
				...
				if (facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
					...
					es.mityc.appfacturae.facturae321.DeliveryNoteType deliveryNote = null;
					...
					for (int k = 0; k < delivNotesCount; k++) {
						...
						deliveryNote = new es.mityc.appfacturae.facturae321.DeliveryNoteType();
				...
				es.mityc.appfacturae.facturae321.InvoiceLineType.TaxesOutputs taxesOutputs2 = new es.mityc.appfacturae.facturae321.InvoiceLineType.TaxesOutputs();

				// 3.1.6.1.22.1 Tax
				es.mityc.appfacturae.facturae321.InvoiceLineType.TaxesOutputs.Tax tax4 = null;
				...
				for (int k = 0; k < taxCount3; k++) {
					...
					tax4 = new es.mityc.appfacturae.facturae321.InvoiceLineType.TaxesOutputs.Tax();
				...
				if (facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
					...
					es.mityc.appfacturae.facturae321.SpecialTaxableEventType specialTaxableEvent = new es.mityc.appfacturae.facturae321.SpecialTaxableEventType();
			...
			if (facturae.getInvoices().getInvoice().get(i).getPaymentDetails() != null
				...
				// 3.1.7.1 Installment	
				es.mityc.appfacturae.facturae321.InstallmentType installment = null;
				...
				for (int j = 0; j < installmentCount; j++) {
					...
					installment = new es.mityc.appfacturae.facturae321.InstallmentType();
	...
	/**
	 * Converts an es.mityc.appfacturae.facturae.Facturae object into an es.mityc.facturae321.Facturae object  ***
	 * @param facturae The es.mityc.appfacturae.facturae.Facturae object to convert
	 * @return The es.mityc.facturae321.Facturae object
	 */
	public static es.mityc.facturae321.Facturae getfacturae321(es.mityc.appfacturae.facturae.Facturae facturae) {

		// 0 es.mityc.facturae321.Facturae
		es.mityc.facturae321.Facturae invoice321 = new es.mityc.facturae321.Facturae();

		// 1 FileHeader
		es.mityc.facturae321.FileHeaderType fileHeader = new es.mityc.facturae321.FileHeaderType();
		...
		// 1.2 Modality
		es.mityc.facturae321.ModalityType modality = es.mityc.facturae321.ModalityType.fromValue(facturae.getFileHeader()
			.getModality().value());
		fileHeader.setModality(modality);

		// 1.3 InvoiceIssuerType
		es.mityc.facturae321.InvoiceIssuerTypeType invoiceIssuerType = es.mityc.facturae321.InvoiceIssuerTypeType
			.fromValue(facturae.getFileHeader().getInvoiceIssuerType().value());
		fileHeader.setInvoiceIssuerType(invoiceIssuerType);
		...
		if (facturae.getFileHeader().getThirdParty() != null) {
			...
			es.mityc.facturae321.ThirdPartyType thirdParty = new es.mityc.facturae321.ThirdPartyType();

			// 1.4.1 TaxIdentification
			es.mityc.facturae321.TaxIdentificationType taxIdentification3 = new es.mityc.facturae321.TaxIdentificationType();

			// 1.4.1.1 PersonTypeCode
			es.mityc.facturae321.PersonTypeCodeType personTypeCode3 = es.mityc.facturae321.PersonTypeCodeType
				.fromValue(facturae.getFileHeader().getThirdParty().getTaxIdentification().getPersonTypeCode().value());
			taxIdentification3.setPersonTypeCode(personTypeCode3);

			// 1.4.1.2 ResidenceTypeCode
			es.mityc.facturae321.ResidenceTypeCodeType residenceTypeCode3 = es.mityc.facturae321.ResidenceTypeCodeType
				.fromValue(facturae.getFileHeader().getThirdParty().getTaxIdentification().getResidenceTypeCode()
					.value());
			taxIdentification3.setResidenceTypeCode(residenceTypeCode3);
			...
			if (facturae.getFileHeader().getThirdParty().getLegalEntity() != null) {
				...
				// 1.4.2.1 LegalEntity
				es.mityc.facturae321.LegalEntityType legalEntity5 = new es.mityc.facturae321.LegalEntityType();
				...
				if (facturae.getFileHeader().getThirdParty().getLegalEntity().getRegistrationData() != null) {
					es.mityc.facturae321.RegistrationDataType registrationData = new es.mityc.facturae321.RegistrationDataType();
				...
				if (facturae.getFileHeader().getThirdParty().getLegalEntity().getAddressInSpain() != null) {
					...
					// 1.4.2.1.4.1 AddressInSpain
					es.mityc.facturae321.AddressType addressInSpain5 = new es.mityc.facturae321.AddressType();
					...
					// 1.4.2.1.4.1.5 CountryCode
					es.mityc.facturae321.CountryType countryCode5 = es.mityc.facturae321.CountryType
					...
					// 1.4.2.1.4.2 OverseasAddress
					es.mityc.facturae321.OverseasAddressType overseasAddress5 = new es.mityc.facturae321.OverseasAddressType();
				...
				// 1.4.2.1.5 ContactDetails
				if (facturae.getFileHeader().getThirdParty().getLegalEntity().getContactDetails() != null) {
					es.mityc.facturae321.ContactDetailsType contactDetails5 = new es.mityc.facturae321.ContactDetailsType();
				...
				// 1.4.2.2 Individual
				es.mityc.facturae321.IndividualType individual5 = new es.mityc.facturae321.IndividualType();
				...
				if (facturae.getFileHeader().getThirdParty().getIndividual().getAddressInSpain() != null) {
					...
					// 1.4.2.2.4.2 OverseasAddress
					es.mityc.facturae321.OverseasAddressType overseasAddressType5 = new es.mityc.facturae321.OverseasAddressType();
		...
		// 1.5 Batch
		es.mityc.facturae321.BatchType batch = new es.mityc.facturae321.BatchType();
		...
		// 1.5.3 TotalInvoicesAmount
		es.mityc.facturae321.AmountType totalInvoicesAmount = new es.mityc.facturae321.AmountType();
		...
		// 1.5.4 TotalOutstandingAmount
		es.mityc.facturae321.AmountType totalOutstandingAmount = new es.mityc.facturae321.AmountType();
		...
		// 1.5.5 TotalExecutableAmount
		es.mityc.facturae321.AmountType totalExecutableAmount = new es.mityc.facturae321.AmountType();
		...
		// 1.5.6 InvoiceCurrencyCode	
		es.mityc.facturae321.CurrencyCodeType invoiceCurrencyCode = es.mityc.facturae321.CurrencyCodeType
		...
		if (facturae.getFileHeader().getFactoringAssignmentData() != null) {
			...
			es.mityc.facturae321.FactoringAssignmentDataType factoringAssignmentData = new es.mityc.facturae321.FactoringAssignmentDataType();

			// 1.6.1 Assignee
			es.mityc.facturae321.AssigneeType assignee = new es.mityc.facturae321.AssigneeType();

			// 1.6.1.1 TaxIdentification
			es.mityc.facturae321.TaxIdentificationType taxIdentification4 = new es.mityc.facturae321.TaxIdentificationType();

			// 1.6.1.1.1 PersonTypeCode
			es.mityc.facturae321.PersonTypeCodeType personTypeCode4 = es.mityc.facturae321.PersonTypeCodeType
				.fromValue(facturae.getFileHeader().getFactoringAssignmentData().getAssignee().getTaxIdentification()
					.getPersonTypeCode().value());
			taxIdentification4.setPersonTypeCode(personTypeCode4);

			// 1.6.1.1.2 ResidenceTypeCode
			es.mityc.facturae321.ResidenceTypeCodeType residenceTypeCode4 = es.mityc.facturae321.ResidenceTypeCodeType
				.fromValue(facturae.getFileHeader().getFactoringAssignmentData().getAssignee().getTaxIdentification()
					.getResidenceTypeCode().value());
			taxIdentification4.setResidenceTypeCode(residenceTypeCode4);
			...
			if (facturae.getFileHeader().getFactoringAssignmentData().getAssignee().getLegalEntity() != null) {
				...
				// 1.6.1.2.1 LegalEntity
				es.mityc.facturae321.LegalEntityType legalEntity = new es.mityc.facturae321.LegalEntityType();
				...
				if (facturae.getFileHeader().getFactoringAssignmentData().getAssignee().getLegalEntity()
					...
					// 1.6.1.2.1.4.1 AddressInSpain
					es.mityc.facturae321.AddressType addressInSpain6 = new es.mityc.facturae321.AddressType();
					...
					// 1.6.1.2.1.4.1.5 CountryCode
					es.mityc.facturae321.CountryType countryCode6 = es.mityc.facturae321.CountryType
						.fromValue(((es.mityc.appfacturae.facturae32.AddressType) (facturae.getFileHeader()
					...
					// 1.6.1.2.1.4.2 OverseasAddress
					es.mityc.facturae321.OverseasAddressType overseasAddress6 = new es.mityc.facturae321.OverseasAddressType();
				...
				if (facturae.getFileHeader().getFactoringAssignmentData().getAssignee().getLegalEntity()
					.getContactDetails() != null) {
					es.mityc.facturae321.ContactDetailsType contactDetails6 = new es.mityc.facturae321.ContactDetailsType();
				...
				//1.6.1.2.2 Individual
				es.mityc.facturae321.IndividualType individual = new es.mityc.facturae321.IndividualType();
			...
			// 1.6.2 PaymentDetails
			es.mityc.facturae321.InstallmentsType paymentDetails = new es.mityc.facturae321.InstallmentsType();

			// 1.6.2.1 Installment	
			es.mityc.facturae321.InstallmentType installment = null;

			// for 14
			int paymentsCount = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
				.getFactoringAssignmentData()).getPaymentDetails().getInstallment().size();
			for (int j = 0; j < paymentsCount; j++) {

				installment = new es.mityc.facturae321.InstallmentType();

				// 1.6.2.1.1 InstallmentDueDate
				XMLGregorianCalendar installmentDueDate = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
					.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
					.getInstallmentDueDate();
				installment.setInstallmentDueDate(installmentDueDate);

				// 1.6.2.1.2 InstallmentAmount
				double installmentAmount = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
					.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
					.getInstallmentAmount();
				installment.setInstallmentAmount(installmentAmount);

				// 1.6.2.1.3 PaymentMeans	
				String paymentMeans = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
					.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
					.getPaymentMeans();
				installment.setPaymentMeans(paymentMeans);

				// 1.6.2.1.4 AccountToBeCredited
				if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
					.getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j).getAccountToBeCredited() != null
					&& ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
						.getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
						.getAccountToBeCredited().getIban() != null
					&& !"".equals(((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
						.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
						.getAccountToBeCredited().getIban())) {
					es.mityc.facturae321.AccountType accountToBeCredited = new es.mityc.facturae321.AccountType();

					// 1.6.2.1.4.1

					// 1.6.2.1.4.1.1 IBAN
					if (!"".equals(((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
						.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
						.getAccountToBeCredited().getIban())) {
						String iban3 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited().getIban();
						accountToBeCredited.setIBAN(iban3);
					}
					...
					// 1.6.2.1.4.1.2 AccountNumber
					if (!""
						.equals(((es.mityc.appfacturae.facturae321.AccountType) ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited()).getAccountNumber())) {
						String accountNumber3 = ((es.mityc.appfacturae.facturae321.AccountType) ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited()).getAccountNumber();
						accountToBeCredited.setAccountNumber(accountNumber3);
					}
					...
					if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
						...
						String bankCode = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited().getBankCode();
						accountToBeCredited.setBankCode(bankCode);
					}
					...
					if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
						...
						String branchCode = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited().getBranchCode();
						accountToBeCredited.setBranchCode(branchCode);
					}
					...
					if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
						...
						// 1.6.2.1.4.4.1 BranchInSpainAddress
						es.mityc.facturae321.AddressType branchInSpainAddress = new es.mityc.facturae321.AddressType();

						// 1.6.2.1.4.4.1.1 Address
						String address7 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited().getBranchInSpainAddress().getAddress();
						branchInSpainAddress.setAddress(address7);

						// 1.6.2.1.4.4.1.2 PostCode
						String postCode8 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited().getBranchInSpainAddress().getPostCode();
						branchInSpainAddress.setPostCode(postCode8);

						// 1.6.2.1.4.4.1.3 Town
						String town7 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited().getBranchInSpainAddress().getTown();
						branchInSpainAddress.setTown(town7);

						// 1.6.2.1.4.4.1.4 Province
						String province7 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited().getBranchInSpainAddress().getProvince();
						branchInSpainAddress.setProvince(province7);

						// 1.6.2.1.4.4.1.5 CountryCode
						es.mityc.facturae321.CountryType countryCode7 = es.mityc.facturae321.CountryType
							.fromValue(((es.mityc.appfacturae.facturae32.AddressType) (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
					...
					} else if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
						.getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
						.getAccountToBeCredited().getOverseasBranchAddress() != null) {

						// 1.6.2.1.4.4.2 OverseasBranchAddress
						es.mityc.facturae321.OverseasAddressType overseasBranchAddress = new es.mityc.facturae321.OverseasAddressType();
						...
						// 1.6.2.1.4.4.2.2 PostCodeAndTown
						String postCodeAndTown8 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
						...
						// 1.6.2.1.4.4.2.4 CountryCode
						es.mityc.facturae321.CountryType countryCode7 = es.mityc.facturae321.CountryType
							.fromValue(((es.mityc.appfacturae.facturae32.OverseasAddressType) (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
								.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment()
					...
					if (!""
						...
						String BIC = ((es.mityc.appfacturae.facturae321.AccountType) ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeCredited()).getBic();
						accountToBeCredited.setBIC(BIC);
					}
				...
				if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
					...
					String paymentReconciliationReference = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
						.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
						.getPaymentReconciliationReference();
					installment.setPaymentReconciliationReference(paymentReconciliationReference);
				}
				...
				if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
					...
					es.mityc.facturae321.AccountType accountToBeDebited = new es.mityc.facturae321.AccountType();
					...
					if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
						...
						String bankCode2 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeDebited().getBankCode();
						accountToBeDebited.setBankCode(bankCode2);
					}
					...
					if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
						...
						String branchCode2 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeDebited().getBranchCode();
						accountToBeDebited.setBranchCode(branchCode2);
					}
					...
					if (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
						...
						// 1.6.2.1.6.4.1 BranchInSpainAddress
						es.mityc.facturae321.AddressType branchInSpainAddress2 = new es.mityc.facturae321.AddressType();

						// 1.6.2.1.6.4.1.1 Address
						String address8 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeDebited().getBranchInSpainAddress().getAddress();
						branchInSpainAddress2.setAddress(address8);

						// 1.6.2.1.6.4.1.2 PostCode
						String postCode9 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeDebited().getBranchInSpainAddress().getPostCode();
						branchInSpainAddress2.setPostCode(postCode9);

						// 1.6.2.1.6.4.1.3 Town
						String town8 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeDebited().getBranchInSpainAddress().getTown();
						branchInSpainAddress2.setTown(town8);

						// 1.6.2.1.6.4.1.4 Province
						String province8 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
							.getAccountToBeDebited().getBranchInSpainAddress().getProvince();
						branchInSpainAddress2.setProvince(province8);

						// 1.6.2.1.6.4.1.5 CountryCode
						es.mityc.facturae321.CountryType countryCode8 = es.mityc.facturae321.CountryType
							.fromValue(((es.mityc.appfacturae.facturae32.AddressType) (((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
								.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment()
						...
						// 1.6.2.1.6.4.2 OverseasBranchAddress
						es.mityc.facturae321.OverseasAddressType overseasBranchAddress2 = new es.mityc.facturae321.OverseasAddressType();
						...
						// 1.6.2.1.6.4.2.2 PostCodeAndTown
						String postCodeAndTown9 = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
							.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
				...
				// 1.6.2.1.7 CollectionAdditionalInformation
				if (!"".equals(((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae.getFileHeader()
					.getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
					.getCollectionAdditionalInformation())) {
					String collectionAdditionalInformation = ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
						.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j)
						.getCollectionAdditionalInformation();
					installment.setCollectionAdditionalInformation(collectionAdditionalInformation);
				}
				...
				// 1.6.2.1.8 RegulatoryReportingData
				if (!""
					.equals(((es.mityc.appfacturae.facturae321.InstallmentType) ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
						.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j))
						.getRegulatoryReportingData())) {
					String regulatoryReportingData = ((es.mityc.appfacturae.facturae321.InstallmentType) ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
						.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j))
						.getRegulatoryReportingData();
					installment.setRegulatoryReportingData(regulatoryReportingData);
				}
				...
				if (!""
					...
					String debitReconciliationReference = ((es.mityc.appfacturae.facturae321.InstallmentType) ((es.mityc.appfacturae.facturae321.FactoringAssignmentDataType) facturae
						.getFileHeader().getFactoringAssignmentData()).getPaymentDetails().getInstallment().get(j))
						.getDebitReconciliationReference();
					installment.setDebitReconciliationReference(debitReconciliationReference);
				}
		...
		invoice321.setFileHeader(fileHeader);

		// 2 PartiesType
		es.mityc.facturae321.PartiesType parties = new es.mityc.facturae321.PartiesType();

		// 2.1 SellerParty
		es.mityc.facturae321.BusinessType sellerParty = new es.mityc.facturae321.BusinessType();

		// 2.1.1 TaxIdentification
		es.mityc.facturae321.TaxIdentificationType taxIdentification = new es.mityc.facturae321.TaxIdentificationType();

		// 2.1.1.1 PersonTypeCode
		es.mityc.facturae321.PersonTypeCodeType personTypeCode = es.mityc.facturae321.PersonTypeCodeType
			.fromValue(facturae.getParties().getSellerParty().getTaxIdentification().getPersonTypeCode().value());
		taxIdentification.setPersonTypeCode(personTypeCode);

		// 2.1.1.2 ResidenceTypeCode
		es.mityc.facturae321.ResidenceTypeCodeType residenceTypeCode = es.mityc.facturae321.ResidenceTypeCodeType
			.fromValue(facturae.getParties().getSellerParty().getTaxIdentification().getResidenceTypeCode().value());
		taxIdentification.setResidenceTypeCode(residenceTypeCode);
		...
		if (facturae.getParties().getSellerParty().getAdministrativeCentres() != null
			&& facturae.getParties().getSellerParty().getAdministrativeCentres().getAdministrativeCentre() != null
			&& facturae.getParties().getSellerParty().getAdministrativeCentres().getAdministrativeCentre().size() > 0) {
			es.mityc.facturae321.AdministrativeCentresType administrativeCentres = new es.mityc.facturae321.AdministrativeCentresType();

			// 2.1.3.1 AdministrativeCentre
			es.mityc.facturae321.AdministrativeCentreType administrativeCentre = null;

			int adminCentreCount = facturae.getParties().getSellerParty().getAdministrativeCentres()
				.getAdministrativeCentre().size();
			for (int i = 0; i < adminCentreCount; i++) {

				administrativeCentre = new es.mityc.facturae321.AdministrativeCentreType();
				...
				if (facturae.getParties().getSellerParty().getAdministrativeCentres().getAdministrativeCentre().get(i)
					...
					// 2.1.3.1.6.1 AddressInSpain		
					es.mityc.facturae321.AddressType addressInSpain3 = new es.mityc.facturae321.AddressType();
					...
					// 2.1.3.1.6.1.5 CountryCode
					es.mityc.facturae321.CountryType countryCode3 = es.mityc.facturae321.CountryType
					...
					// 2.1.3.1.6.2 OverSeasAddress
					es.mityc.facturae321.OverseasAddressType overseasAddress3 = new es.mityc.facturae321.OverseasAddressType();
				...
				if (facturae.getParties().getSellerParty().getAdministrativeCentres().getAdministrativeCentre().get(i)
					.getContactDetails() != null) {
					es.mityc.facturae321.ContactDetailsType contactDetails3 = new es.mityc.facturae321.ContactDetailsType();
				...
				// 2.1.3.1.10 CentreDescription
				if (!"".equals(((es.mityc.appfacturae.facturae321.AdministrativeCentreType) facturae.getParties()
					.getSellerParty().getAdministrativeCentres().getAdministrativeCentre().get(i))
					.getCentreDescription())) {
					String centreDescription = ((es.mityc.appfacturae.facturae321.AdministrativeCentreType) facturae
		...
		if (facturae.getParties().getSellerParty().getLegalEntity() != null) {
			...
			if (facturae.getParties().getSellerParty().getLegalEntity().getAddressInSpain() != null) {
				...
				//2.1.4.1.4.1 AddressInSpain
				es.mityc.facturae321.AddressType addressInSpain = new es.mityc.facturae321.AddressType();
				...
				// 2.1.4.1.4.1.5 CountryCode
				es.mityc.facturae321.CountryType countryCode = es.mityc.facturae321.CountryType
				...
				// 2.1.4.1.4.2 OverseasAddress
				es.mityc.facturae321.OverseasAddressType overseasAddress = new es.mityc.facturae321.OverseasAddressType();
				// 2.1.4.1.4.2.1 Address
			...
			// 2.1.4.1.5 ContactDetails
			if (facturae.getParties().getSellerParty().getLegalEntity().getContactDetails() != null) {
				es.mityc.facturae321.ContactDetailsType contactDetails = new es.mityc.facturae321.ContactDetailsType();
		...
		// 2.2 BuyerParty 	
		es.mityc.facturae321.BusinessType buyerParty = new es.mityc.facturae321.BusinessType();

		// 2.2.1 TaxIdentification
		es.mityc.facturae321.TaxIdentificationType taxIdentification2 = new es.mityc.facturae321.TaxIdentificationType();

		// 2.2.1.1 PersonTypeCode
		es.mityc.facturae321.PersonTypeCodeType personTypeCode2 = es.mityc.facturae321.PersonTypeCodeType
			.fromValue(facturae.getParties().getBuyerParty().getTaxIdentification().getPersonTypeCode().value());
		taxIdentification2.setPersonTypeCode(personTypeCode2);

		// 2.2.1.2 ResidenceTypeCode
		es.mityc.facturae321.ResidenceTypeCodeType residenceTypeCode2 = es.mityc.facturae321.ResidenceTypeCodeType
			.fromValue(facturae.getParties().getBuyerParty().getTaxIdentification().getResidenceTypeCode().value());
		taxIdentification2.setResidenceTypeCode(residenceTypeCode2);
		...
		if (facturae.getParties().getBuyerParty().getAdministrativeCentres() != null
			&& facturae.getParties().getBuyerParty().getAdministrativeCentres().getAdministrativeCentre() != null
			&& facturae.getParties().getBuyerParty().getAdministrativeCentres().getAdministrativeCentre().size() > 0) {
			es.mityc.facturae321.AdministrativeCentresType administrativeCentres2 = new es.mityc.facturae321.AdministrativeCentresType();

			// 2.2.3.1 AdministrativeCentre
			es.mityc.facturae321.AdministrativeCentreType administrativeCentre2 = null;

			int adminCentreCount = facturae.getParties().getBuyerParty().getAdministrativeCentres()
				.getAdministrativeCentre().size();
			for (int i = 0; i < adminCentreCount; i++) {

				administrativeCentre2 = new es.mityc.facturae321.AdministrativeCentreType();
				...
				if (facturae.getParties().getBuyerParty().getAdministrativeCentres().getAdministrativeCentre().get(i)
					...
					// 2.2.3.1.6.1 AddressInSpain
					es.mityc.facturae321.AddressType addressInSpain4 = new es.mityc.facturae321.AddressType();
					...
					// 2.2.3.1.6.1.5 CountryCode
					es.mityc.facturae321.CountryType countryCode4 = es.mityc.facturae321.CountryType
						.fromValue(((es.mityc.appfacturae.facturae32.AddressType) (facturae.getParties()
					...
					// 2.2.3.1.6.2 OverSeasAddress
					es.mityc.facturae321.OverseasAddressType overseasAddress4 = new es.mityc.facturae321.OverseasAddressType();
				...
				if (facturae.getParties().getBuyerParty().getAdministrativeCentres().getAdministrativeCentre().get(i)
					.getContactDetails() != null) {
					es.mityc.facturae321.ContactDetailsType contactDetails4 = new es.mityc.facturae321.ContactDetailsType();
		...
		if (facturae.getParties().getBuyerParty().getLegalEntity() != null) {
			...
			if (facturae.getParties().getBuyerParty().getLegalEntity().getAddressInSpain() != null) {
				...
				//2.2.4.1.4.1 AddressInSpain
				es.mityc.facturae321.AddressType addressInSpain2 = new es.mityc.facturae321.AddressType();
				...
				// 2.2.4.1.4.1.5 CountryCode
				es.mityc.facturae321.CountryType countryCode2 = es.mityc.facturae321.CountryType
				...
				// 2.2.4.1.4.2 OverseasAddress
				es.mityc.facturae321.OverseasAddressType overseasAddress2 = new es.mityc.facturae321.OverseasAddressType();
			...
			// 2.2.4.1.5 ContactDetails
			if (facturae.getParties().getBuyerParty().getLegalEntity().getContactDetails() != null) {
				es.mityc.facturae321.ContactDetailsType contactDetails2 = new es.mityc.facturae321.ContactDetailsType();
			...
			// 2.2.4.2 Individual
			es.mityc.facturae321.IndividualType individual2 = new es.mityc.facturae321.IndividualType();
		...
		invoice321.setParties(parties);

		// 3 Invoices
		es.mityc.facturae321.InvoicesType invoices = new es.mityc.facturae321.InvoicesType();

		// 3.1 Invoice
		es.mityc.facturae321.InvoiceType invoiceType = null;

		// for 1
		int invoiceCount = facturae.getInvoices().getInvoice().size();
		for (int i = 0; i < invoiceCount; i++) {

			invoiceType = new es.mityc.facturae321.InvoiceType();

			// 3.1.1 InvoiceHeader
			es.mityc.facturae321.InvoiceHeaderType invoiceHeader = new es.mityc.facturae321.InvoiceHeaderType();
			...
			// 3.1.1.3 InvoiceDocumentType
			es.mityc.facturae321.InvoiceDocumentTypeType invoiceDocumentType = es.mityc.facturae321.InvoiceDocumentTypeType
				.fromValue(facturae.getInvoices().getInvoice().get(i).getInvoiceHeader().getInvoiceDocumentType()
					.value());
			invoiceHeader.setInvoiceDocumentType(invoiceDocumentType);

			// 3.1.1.4 InvoiceClass 	
			es.mityc.facturae321.InvoiceClassType invoiceClass = es.mityc.facturae321.InvoiceClassType.fromValue(facturae
				.getInvoices().getInvoice().get(i).getInvoiceHeader().getInvoiceClass().value());
			invoiceHeader.setInvoiceClass(invoiceClass);

			// 3.1.1.5 Corrective
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceHeader().getCorrective() != null) {
				es.mityc.facturae321.CorrectiveType corrective = new es.mityc.facturae321.CorrectiveType();
				...
				// 3.1.1.5.4 ReasonDescription
				es.mityc.facturae321.ReasonDescriptionType reasonDescription = es.mityc.facturae321.ReasonDescriptionType
					.fromValue(((es.mityc.appfacturae.facturae321.CorrectiveType) (facturae.getInvoices().getInvoice()
						.get(i).getInvoiceHeader().getCorrective())).getReasonDescription().value());
				corrective.setReasonDescription(reasonDescription);

				// 3.1.1.5.5 TaxPeriod
				es.mityc.facturae321.PeriodDates taxPeriod = new es.mityc.facturae321.PeriodDates();
				...
				// 3.1.1.5.7 CorrectionMethodDescription
				es.mityc.facturae321.CorrectionMethodDescriptionType correctionMethodDescription = es.mityc.facturae321.CorrectionMethodDescriptionType
					.fromValue(facturae.getInvoices().getInvoice().get(i).getInvoiceHeader().getCorrective()
						.getCorrectionMethodDescription().value());
				corrective.setCorrectionMethodDescription(correctionMethodDescription);

				// 3.1.1.5.8 AdditionalReasonDescription
				if (!"".equals(((es.mityc.appfacturae.facturae321.CorrectiveType) facturae.getInvoices().getInvoice()
					.get(i).getInvoiceHeader().getCorrective()).getAdditionalReasonDescription())) {
					String additionalReasonDescription = ((es.mityc.appfacturae.facturae321.CorrectiveType) facturae
			...
			// 3.1.2 InvoiceIssueData
			es.mityc.facturae321.InvoiceIssueDataType invoiceIssueData = new es.mityc.facturae321.InvoiceIssueDataType();
			...
			// 3.1.2.2 OperationDate
			if (((es.mityc.appfacturae.facturae321.InvoiceIssueDataType) facturae.getInvoices().getInvoice().get(i)
				.getInvoiceIssueData()).getOperationDate() != null) {
				XMLGregorianCalendar operationDate = ((es.mityc.appfacturae.facturae321.InvoiceIssueDataType) (facturae
			...
			// 3.1.2.3 PlaceOfIssue
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceIssueData().getPlaceOfIssue() != null) {
				es.mityc.facturae321.PlaceOfIssueType placeOfIssue = new es.mityc.facturae321.PlaceOfIssueType();
			...
			// 3.1.2.4 InvoicingPeriod
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceIssueData().getInvoicingPeriod() != null) {
				es.mityc.facturae321.PeriodDates invoicingPeriod = new es.mityc.facturae321.PeriodDates();
			...
			// 3.1.2.5 InvoiceCurrencyCode
			es.mityc.facturae321.CurrencyCodeType invoiceCurrencyCode2 = es.mityc.facturae321.CurrencyCodeType
				.fromValue(((es.mityc.appfacturae.facturae321.InvoiceIssueDataType) (facturae.getInvoices().getInvoice()
					.get(i).getInvoiceIssueData())).getInvoiceCurrencyCode().value());
			invoiceIssueData.setInvoiceCurrencyCode(invoiceCurrencyCode2);

			// 3.1.2.6 ExchangeRateDetails
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceIssueData().getExchangeRateDetails() != null) {
				es.mityc.facturae321.ExchangeRateDetailsType exchangeRateDetails = new es.mityc.facturae321.ExchangeRateDetailsType();
			...
			// 3.1.2.7 TaxCurrencyCode
			es.mityc.facturae321.CurrencyCodeType taxCurrencyCode = es.mityc.facturae321.CurrencyCodeType
				.fromValue(((es.mityc.appfacturae.facturae321.InvoiceIssueDataType) (facturae.getInvoices().getInvoice()
					.get(i).getInvoiceIssueData())).getTaxCurrencyCode().value());
			invoiceIssueData.setTaxCurrencyCode(taxCurrencyCode);

			// 3.1.2.8 LanguageName
			es.mityc.facturae321.LanguageCodeType languageName = es.mityc.facturae321.LanguageCodeType
				.fromValue(((es.mityc.appfacturae.facturae321.InvoiceIssueDataType) (facturae.getInvoices().getInvoice()
			...
			// 3.1.3 TaxesOutputs
			es.mityc.facturae321.InvoiceType.TaxesOutputs taxesOutputs = new es.mityc.facturae321.InvoiceType.TaxesOutputs();

			// 3.1.3.1 Tax
			es.mityc.facturae321.TaxOutputType tax = null;
			// for 2
			int taxCount = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
				.getTaxesOutputs().getTax().size();
			for (int j = 0; j < taxCount; j++) {

				tax = new es.mityc.facturae321.TaxOutputType();

				// 3.1.3.1.1 TaxTypeCode
				String taxTypeCode = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
					.getInvoice().get(i))).getTaxesOutputs().getTax().get(j).getTaxTypeCode();
				tax.setTaxTypeCode(taxTypeCode);

				// 3.1.3.1.2 TaxRate
				double taxRate = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice()
					.get(i))).getTaxesOutputs().getTax().get(j).getTaxRate();
				tax.setTaxRate(taxRate);

				// 3.1.3.1.3 TaxableBase
				es.mityc.facturae321.AmountType taxableBase = new es.mityc.facturae321.AmountType();

				// 3.1.3.1.3.1 TotalAmount
				double totalAmount4 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
					.getInvoice().get(i))).getTaxesOutputs().getTax().get(j).getTaxableBase().getTotalAmount();
				taxableBase.setTotalAmount(totalAmount4);

				// 3.1.3.1.3.2 EquivalentInEuros
				if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
					.getTaxesOutputs().getTax().get(j).getTaxableBase().getEquivalentInEuros() != null) {
					Double equivalentInEuros4 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
				...
				if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
					...
					es.mityc.facturae321.AmountType taxAmount = new es.mityc.facturae321.AmountType();

					// 3.1.3.1.4.1 TotalAmount
					double totalAmount5 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
						...
						Double equivalentInEuros5 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
				...
				if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
					...
					es.mityc.facturae321.AmountType specialTaxableBase = new es.mityc.facturae321.AmountType();

					// 3.1.3.1.5.1 TotalAmount
					double totalAmount17 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
						...
						Double equivalentInEuros17 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
				...
				if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
					...
					es.mityc.facturae321.AmountType specialTaxAmount = new es.mityc.facturae321.AmountType();

					// 3.1.3.1.6.1 TotalAmount
					double totalAmount18 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
						...
						Double equivalentInEuros18 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
							.getInvoices().getInvoice().get(i))).getTaxesOutputs().getTax().get(j)
				...
				if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
					...
					Double equivalenceSurcharge = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
						.getInvoices().getInvoice().get(i))).getTaxesOutputs().getTax().get(j)
				...
				if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
					...
					es.mityc.facturae321.AmountType equivalenceSurchargeAmount = new es.mityc.facturae321.AmountType();

					// 3.1.3.1.8.1 TotalAmount
					double totalAmount19 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
						...
						Double equivalentInEuros19 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
							.getInvoices().getInvoice().get(i))).getTaxesOutputs().getTax().get(j)
							.getEquivalenceSurchargeAmount().getEquivalentInEuros();
						equivalenceSurchargeAmount.setEquivalentInEuros(equivalentInEuros19);
					}
			...
			if (facturae.getInvoices().getInvoice().get(i).getTaxesWithheld() != null
				&& facturae.getInvoices().getInvoice().get(i).getTaxesWithheld().getTax() != null
				&& facturae.getInvoices().getInvoice().get(i).getTaxesWithheld().getTax().size() > 0) {
				es.mityc.facturae321.TaxesType taxesWithheld = new es.mityc.facturae321.TaxesType();

				// 3.1.4.1 Tax
				es.mityc.facturae321.TaxType tax2 = null;

				// for 3
				int taxCount2 = facturae.getInvoices().getInvoice().get(i).getTaxesWithheld().getTax().size();
				for (int j = 0; j < taxCount2; j++) {

					tax2 = new es.mityc.facturae321.TaxType();
					...
					// 3.1.4.1.3 TaxableBase
					es.mityc.facturae321.AmountType taxableBase2 = new es.mityc.facturae321.AmountType();
					...
					// 3.1.4.1.4 TaxAmount
					if (facturae.getInvoices().getInvoice().get(i).getTaxesWithheld().getTax().get(j).getTaxAmount() != null) {
						es.mityc.facturae321.AmountType taxAmount2 = new es.mityc.facturae321.AmountType();
			...
			// 3.1.5 InvoiceTotals
			es.mityc.facturae321.InvoiceTotalsType invoiceTotals = new es.mityc.facturae321.InvoiceTotalsType();
			...
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getGeneralDiscounts() != null
				...
				&& facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getGeneralDiscounts().getDiscount()
					.size() > 0) {
				es.mityc.facturae321.DiscountsAndRebatesType generalDiscounts = new es.mityc.facturae321.DiscountsAndRebatesType();

				// 3.1.5.2.1 Discount
				es.mityc.facturae321.DiscountType discount = null;
				...
				for (int j = 0; j < discountsCount; j++) {
					...
					discount = new es.mityc.facturae321.DiscountType();
			...
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getGeneralSurcharges() != null
				...
				&& facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getGeneralSurcharges().getCharge()
					.size() > 0) {
				es.mityc.facturae321.ChargesType generalSurcharges = new es.mityc.facturae321.ChargesType();

				// 3.1.5.3.1 Charge
				es.mityc.facturae321.ChargeType charge = null;
				...
				for (int j = 0; j < surchargesCount; j++) {
					...
					charge = new es.mityc.facturae321.ChargeType();
			...
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getSubsidies() != null
				&& facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getSubsidies().getSubsidy() != null
				&& facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getSubsidies().getSubsidy().size() > 0) {
				es.mityc.facturae321.SubsidiesType subsidies = new es.mityc.facturae321.SubsidiesType();

				// 3.1.5.10.1 Subsidy
				es.mityc.facturae321.SubsidyType subsidy = null;
				...
				for (int j = 0; j < subsidyCount; j++) {
					...
					subsidy = new es.mityc.facturae321.SubsidyType();
			...
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getPaymentsOnAccount() != null
				...
				&& facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getPaymentsOnAccount()
					.getPaymentOnAccount().size() > 0) {
				es.mityc.facturae321.PaymentsOnAccountType paymentsOnAccount = new es.mityc.facturae321.PaymentsOnAccountType();

				// 3.1.5.11.1 PaymentOnAccount
				es.mityc.facturae321.PaymentOnAccountType paymentOnAccount = null;
				...
				for (int j = 0; j < paymentCount; j++) {
					...
					paymentOnAccount = new es.mityc.facturae321.PaymentOnAccountType();
			...
			// 3.1.5.12 ReimbursableExpenses
			if (((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices().getInvoice().get(i)
				.getInvoiceTotals())).getReimbursableExpenses() != null
				&& ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices().getInvoice().get(i)
				...
				es.mityc.facturae321.ReimbursableExpenses reimbursableExpenses = new es.mityc.facturae321.ReimbursableExpenses();

				// 3.1.5.12.1 ReimbursableExpenses
				es.mityc.facturae321.ReimbursableExpensesType reimbursableExpenses2 = null;

				// for 7 bis
				int reimExpCount = ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices()
					.getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses().getReimbursableExpenses()
					.size();
				for (int j = 0; j < reimExpCount; j++) {

					reimbursableExpenses2 = new es.mityc.facturae321.ReimbursableExpensesType();

					// 3.1.5.12.1.1 ReimbursableExpensesSellerParty
					if (((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices().getInvoice()
						.get(i).getInvoiceTotals())).getReimbursableExpenses().getReimbursableExpenses().get(j)
						.getReimbursableExpensesSellerParty() != null
						&& !"".equals(((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices()
							...
							.getTaxIdentificationNumber())) {
						es.mityc.facturae321.TaxIdentificationType reimbursableExpensesSellerParty = new es.mityc.facturae321.TaxIdentificationType();

						// 3.1.5.12.1.1.1 PersonTypeCode
						es.mityc.facturae321.PersonTypeCodeType personTypeCode9 = es.mityc.facturae321.PersonTypeCodeType
							.fromValue(((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices()
								.getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses()
								.getReimbursableExpenses().get(j).getReimbursableExpensesSellerParty()
								.getPersonTypeCode().value());
						reimbursableExpensesSellerParty.setPersonTypeCode(personTypeCode9);
						...
						// 3.1.5.12.1.1.2 ResidenceTypeCode
						es.mityc.facturae321.ResidenceTypeCodeType residenceTypeCode9 = es.mityc.facturae321.ResidenceTypeCodeType
							.fromValue(((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices()
								.getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses()
								.getReimbursableExpenses().get(j).getReimbursableExpensesSellerParty()
								.getResidenceTypeCode().value());
						...
						// 3.1.5.12.1.1.3 TaxIdentificationNumber
						String taxIdentificationNumber9 = ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices().getInvoice()
						...
						&& !"".equals(((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices()
							...
							.getTaxIdentificationNumber())) {
						es.mityc.facturae321.TaxIdentificationType reimbursableExpensesBuyerParty = new es.mityc.facturae321.TaxIdentificationType();

						// 3.1.5.12.1.2.1 PersonTypeCode
						es.mityc.facturae321.PersonTypeCodeType personTypeCode10 = es.mityc.facturae321.PersonTypeCodeType
							.fromValue(((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices()
								.getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses()
								.getReimbursableExpenses().get(j).getReimbursableExpensesBuyerParty()
								.getPersonTypeCode().value());
						...
						// 3.1.5.12.1.2.2 ResidenceTypeCode
						es.mityc.facturae321.ResidenceTypeCodeType residenceTypeCode10 = es.mityc.facturae321.ResidenceTypeCodeType
							.fromValue(((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices()
								.getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses()
								.getReimbursableExpenses().get(j).getReimbursableExpensesBuyerParty()
								.getResidenceTypeCode().value());
						...
						// 3.1.5.12.1.2.3 TaxIdentificationNumber
						String taxIdentificationNumber10 = ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae
							.getInvoices().getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses()
							.getReimbursableExpenses().get(j).getReimbursableExpensesBuyerParty()
							.getTaxIdentificationNumber();
						reimbursableExpensesBuyerParty.setTaxIdentificationNumber(taxIdentificationNumber10);
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices().getInvoice()
						.get(i).getInvoiceTotals())).getReimbursableExpenses().getReimbursableExpenses().get(j)
						.getIssueDate() != null) {
						XMLGregorianCalendar issueDate3 = ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae
							.getInvoices().getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses()
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices().getInvoice()
						...
						String invoiceNumber5 = ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae
							.getInvoices().getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses()
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices().getInvoice()
						...
						String invoiceSeriesCode5 = ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae
							.getInvoices().getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses()
					...
					// 3.1.5.12.1.6 ReimbursableExpensesAmount
					double reimbursableExpensesAmount = ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae
						.getInvoices().getInvoice().get(i).getInvoiceTotals())).getReimbursableExpenses()
			...
			if (((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices().getInvoice().get(i)
				...
				Double totalFinancialExpenses = ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae
			...
			// 3.1.5.16 AmountsWithheld
			if (facturae.getInvoices().getInvoice().get(i).getInvoiceTotals().getAmountsWithheld() != null) {
				es.mityc.facturae321.AmountsWithheldType amountsWithheld = new es.mityc.facturae321.AmountsWithheldType();
			...
			if (((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae.getInvoices().getInvoice().get(i)
				...
				Double totalReimbursableExpenses = ((es.mityc.appfacturae.facturae321.InvoiceTotalsType) (facturae
			...
			// 3.1.6 Items
			es.mityc.facturae321.ItemsType items = new es.mityc.facturae321.ItemsType();

			// 3.1.6.1 InvoiceLine
			es.mityc.facturae321.InvoiceLineType invoiceLine = null;

			// for 8
			int invLineCount = facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().size();
			for (int j = 0; j < invLineCount; j++) {

				invoiceLine = new es.mityc.facturae321.InvoiceLineType();
				...
				// 3.1.6.1.2 IssuerContractDate
				if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices().getInvoice()
					.get(i).getItems().getInvoiceLine().get(j)).getIssuerContractDate())) {
					XMLGregorianCalendar issuerContractDate = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae
				...
				if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices().getInvoice()
					...
					XMLGregorianCalendar issuerTransactionDate = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae
				...
				if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices().getInvoice()
					...
					XMLGregorianCalendar receiverContractDate = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae
						.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j))
						.getReceiverContractDate();
					invoiceLine.setReceiverContractDate(receiverContractDate);
				}
				...
				if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices().getInvoice()
					...
					XMLGregorianCalendar receiverTransactionDate = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae
						.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j))
						.getReceiverTransactionDate();
					invoiceLine.setReceiverTransactionDate(receiverTransactionDate);
				}
				...
				if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices().getInvoice()
					...
					String fileReference = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices()
				...
				if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices().getInvoice()
					...
					XMLGregorianCalendar fileDate = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae
				...
				if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices().getInvoice()
					...
					Double sequenceNumber = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices()
				...
				if (facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
					...
					&& facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
						.getDeliveryNotesReferences().getDeliveryNote().size() > 0) {
					es.mityc.facturae321.DeliveryNotesReferencesType deliveryNotesReferences = new es.mityc.facturae321.DeliveryNotesReferencesType();

					// 3.1.6.1.12.1 DeliveryNote
					es.mityc.facturae321.DeliveryNoteType deliveryNote = null;
					...
					for (int k = 0; k < deliveriesCount; k++) {
						...
						deliveryNote = new es.mityc.facturae321.DeliveryNoteType();
						...
						// 3.1.6.1.12.1.2 DeliveryNoteDate
						if (!"".equals(((es.mityc.appfacturae.facturae321.DeliveryNoteType) facturae.getInvoices()
							.getInvoice().get(i).getItems().getInvoiceLine().get(j).getDeliveryNotesReferences()
							.getDeliveryNote().get(k)).getDeliveryNoteDate())) {
							XMLGregorianCalendar deliveryNoteDate = ((es.mityc.appfacturae.facturae321.DeliveryNoteType) facturae
								.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
								.getDeliveryNotesReferences().getDeliveryNote().get(k)).getDeliveryNoteDate();
							deliveryNote.setDeliveryNoteDate(deliveryNoteDate);
						}
				...
				if (facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
					...
					&& facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
						.getDiscountsAndRebates().getDiscount().size() > 0) {
					es.mityc.facturae321.DiscountsAndRebatesType discountsAndRebates = new es.mityc.facturae321.DiscountsAndRebatesType();

					// 3.1.6.1.18.1 Discount
					es.mityc.facturae321.DiscountType discount2 = null;
					...
					for (int k = 0; k < discountsCount; k++) {
						...
						discount2 = new es.mityc.facturae321.DiscountType();
				...
				if (facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j).getCharges() != null
					...
					&& facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j).getCharges()
						.getCharge().size() > 0) {
					es.mityc.facturae321.ChargesType charges = new es.mityc.facturae321.ChargesType();

					// 3.1.6.1.19.1 Charge
					es.mityc.facturae321.ChargeType charge2 = null;
					...
					for (int k = 0; k < chargesCount; k++) {
						...
						charge2 = new es.mityc.facturae321.ChargeType();
				...
				if (facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j).getTaxesWithheld() != null
					...
					&& facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j).getTaxesWithheld()
						.getTax().size() > 0) {
					es.mityc.facturae321.TaxesType taxesWithheld2 = new es.mityc.facturae321.TaxesType();

					// 3.1.6.1.21.1 Tax
					es.mityc.facturae321.TaxType tax3 = null;
					...
					for (int k = 0; k < taxesWithheldCount; k++) {
						...
						tax3 = new es.mityc.facturae321.TaxType();
						...
						// 3.1.6.1.21.1.3 TaxableBase
						es.mityc.facturae321.AmountType taxableBase3 = new es.mityc.facturae321.AmountType();
						...
						if (facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
							.getTaxesWithheld().getTax().get(k).getTaxAmount() != null) {
							es.mityc.facturae321.AmountType taxAmount3 = new es.mityc.facturae321.AmountType();
				...
				// 3.1.6.1.22 TaxesOutputs
				es.mityc.facturae321.InvoiceLineType.TaxesOutputs taxesOutputs2 = new es.mityc.facturae321.InvoiceLineType.TaxesOutputs();

				// 3.1.6.1.22.1 Tax
				es.mityc.facturae321.InvoiceLineType.TaxesOutputs.Tax tax4 = null;

				// for 13
				int taxesOutputsCount = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices()
					.getInvoice().get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs().getTax().size();
				for (int k = 0; k < taxesOutputsCount; k++) {

					tax4 = new es.mityc.facturae321.InvoiceLineType.TaxesOutputs.Tax();

					// 3.1.6.1.22.1.1 TaxTypeCode
					String taxTypeCode4 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices()
						.getInvoice().get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs().getTax().get(k)
						.getTaxTypeCode();
					tax4.setTaxTypeCode(taxTypeCode4);

					// 3.1.6.1.22.1.2 TaxRate
					double taxRate4 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices()
						.getInvoice().get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs().getTax().get(k)
						.getTaxRate();
					tax4.setTaxRate(taxRate4);

					// 3.1.6.1.22.1.3 TaxableBase
					es.mityc.facturae321.AmountType taxableBase4 = new es.mityc.facturae321.AmountType();

					// 3.1.6.1.22.1.3.1 TotalAmount
					double totalAmount10 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices()
						.getInvoice().get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs().getTax().get(k)
						.getTaxableBase().getTotalAmount();
					taxableBase4.setTotalAmount(totalAmount10);

					// 3.1.6.1.22.1.3.2 EquivalentInEuros
					if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice().get(i)
						.getItems().getInvoiceLine().get(j))).getTaxesOutputs().getTax().get(k).getTaxableBase()
						.getEquivalentInEuros() != null) {
						Double equivalentInEuros10 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice().get(i)
						...
						// 3.1.6.1.22.1.4.1 TotalAmount
						double totalAmount5 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
							.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs()
							.getTax().get(k).getTaxAmount().getTotalAmount();
						taxAmount.setTotalAmount(totalAmount5);

						// 3.1.6.1.22.1.4.2 EquivalentInEuros
						if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice()
							.get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs().getTax().get(k)
							.getTaxAmount().getEquivalentInEuros() != null) {
							Double equivalentInEuros5 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
								.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)))
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice().get(i)
						...
						// 3.1.6.1.22.1.5.1 TotalAmount
						double totalAmount17 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
							.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs()
						...
						if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice()
							.get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs().getTax().get(k)
							.getSpecialTaxableBase().getEquivalentInEuros() != null) {
							Double equivalentInEuros17 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
								.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)))
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice().get(i)
						...
						// 3.1.6.1.22.1.6.1 TotalAmount
						double totalAmount18 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
							.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs()
						...
						if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice()
							.get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs().getTax().get(k)
							.getSpecialTaxAmount().getEquivalentInEuros() != null) {
							Double equivalentInEuros18 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
								.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)))
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice().get(i)
						...
						.getEquivalenceSurcharge() != null) {
						Double equivalenceSurcharge = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
							.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs()
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice().get(i)
						...
						double totalAmount19 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
							.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs()
						...
						if (((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae.getInvoices().getInvoice()
							.get(i).getItems().getInvoiceLine().get(j))).getTaxesOutputs().getTax().get(k)
							.getEquivalenceSurchargeAmount().getEquivalentInEuros() != null) {
							Double equivalentInEuros19 = ((es.mityc.appfacturae.facturae321.InvoiceLineType) (facturae
								.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)))
				...
				// 3.1.6.1.23 LineItemPeriod
				if (facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j).getLineItemPeriod() != null) {
					es.mityc.facturae321.PeriodDates lineItemPeriod = new es.mityc.facturae321.PeriodDates();
				...
				if (((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices().getInvoice().get(i)
					...
					es.mityc.facturae321.SpecialTaxableEventType specialTaxableEvent = new es.mityc.facturae321.SpecialTaxableEventType();

					// 3.1.6.1.26.1 SpecialTaxableEventCode
					String specialTaxableEventCode = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae
						.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)).getSpecialTaxableEvent()
						.getSpecialTaxableEventCode();
					specialTaxableEvent.setSpecialTaxableEventCode(specialTaxableEventCode);

					// 3.1.6.1.26.2 SpecialTaxableEventReason
					String specialTaxableEventReason = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae
						.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)).getSpecialTaxableEvent()
				...
				if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices().getInvoice()
					...
					String articleCode = ((es.mityc.appfacturae.facturae321.InvoiceLineType) facturae.getInvoices()
				...
				if (facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j).getExtensions() != null
					...
					&& facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j).getExtensions()
						.getAny().size() > 0) {
					es.mityc.facturae321.ExtensionsType extensions = null;

					// 3.1.6.1.20.1 [any]
					int extensionsCount = facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
						.getExtensions().getAny().size();
					for (int k = 0; k < extensionsCount; k++) {
						extensions = new es.mityc.facturae321.ExtensionsType();
						extensions.getAny().add(
							facturae.getInvoices().getInvoice().get(i).getItems().getInvoiceLine().get(j)
								.getExtensions().getAny().get(k));
					}
			...
			if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
				...
				&& ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
					.getPaymentDetails().getInstallment() != null
				&& ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
					.getPaymentDetails().getInstallment().size() > 0) {
				es.mityc.facturae321.InstallmentsType paymentDetails2 = new es.mityc.facturae321.InstallmentsType();

				// 3.1.7.1 Installment	
				es.mityc.facturae321.InstallmentType installment = null;

				// for 14
				int paymentsCount = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice()
				...
				for (int j = 0; j < paymentsCount; j++) {
					...
					// 3.1.7.1.1 InstallmentDueDate
					XMLGregorianCalendar installmentDueDate = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
						.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
						.getInstallmentDueDate();
					installment.setInstallmentDueDate(installmentDueDate);

					// 3.1.7.1.2 InstallmentAmount
					double installmentAmount = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
						.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j).getInstallmentAmount();
					installment.setInstallmentAmount(installmentAmount);

					// 3.1.7.1.3 PaymentMeans	
					String paymentMeans = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
						...
						&& !"".equals(((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
						...
						// 3.1.7.1.4.1.1 IBAN
						if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
							.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j).getAccountToBeCredited()
							.getIban())) {
							String iban3 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
						...
						// 3.1.7.1.4.1.2 AccountNumber
						if (!""
							.equals(((es.mityc.appfacturae.facturae321.AccountType) ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
								.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited()).getAccountNumber())) {
							String accountNumber3 = ((es.mityc.appfacturae.facturae321.AccountType) ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
								.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited()).getAccountNumber();
							accountToBeCredited.setAccountNumber(accountNumber3);
						}
						...
						if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
							...
							&& !"".equals(((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited().getBankCode())) {
							String bankCode = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited().getBankCode();
							accountToBeCredited.setBankCode(bankCode);
						}
						...
						if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
							...
							&& !"".equals(((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited().getBranchCode())) {
							String branchCode = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited().getBranchCode();
							accountToBeCredited.setBranchCode(branchCode);
						}
						...
						if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
							...
							// 3.1.7.1.4.4.1.1 Address
							String address7 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited().getBranchInSpainAddress().getAddress();
							branchInSpainAddress.setAddress(address7);

							// 3.1.7.1.4.4.1.2 PostCode
							String postCode8 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited().getBranchInSpainAddress().getPostCode();
							branchInSpainAddress.setPostCode(postCode8);

							// 3.1.7.1.4.4.1.3 Town
							String town7 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited().getBranchInSpainAddress().getTown();
							branchInSpainAddress.setTown(town7);

							// 3.1.7.1.4.4.1.4 Province
							String province7 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited().getBranchInSpainAddress().getProvince();
							branchInSpainAddress.setProvince(province7);
							...
							// 3.1.7.1.4.4.1.5 CountryCode
							es.mityc.facturae321.CountryType countryCode7 = es.mityc.facturae321.CountryType
								.fromValue(((es.mityc.appfacturae.facturae32.AddressType) (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
									.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
						...
						} else if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice()
							...
							// 3.1.7.1.4.4.2.2 PostCodeAndTown
							String postCodeAndTown8 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
								.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited().getOverseasBranchAddress().getPostCodeAndTown();
							overseasBranchAddress.setPostCodeAndTown(postCodeAndTown8);
							...
							// 3.1.7.1.4.4.2.4 CountryCode
							es.mityc.facturae321.CountryType countryCode7 = es.mityc.facturae321.CountryType
								.fromValue(((es.mityc.appfacturae.facturae32.OverseasAddressType) (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
									.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
						...
						if (!""
							.equals(((es.mityc.appfacturae.facturae321.AccountType) ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
								.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited()).getBic())) {
							String BIC = ((es.mityc.appfacturae.facturae321.AccountType) ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
								.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeCredited()).getBic();
							accountToBeCredited.setBIC(BIC);
						}
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
						...
						&& !"".equals(((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
							.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
							.getPaymentReconciliationReference())) {
						String paymentReconciliationReference = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
							.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
							.getPaymentReconciliationReference();
						installment.setPaymentReconciliationReference(paymentReconciliationReference);
					}
					...
					if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
						...
						if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
							...
							&& !"".equals(((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeDebited().getBankCode())) {
							String bankCode2 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeDebited().getBankCode();
							accountToBeDebited.setBankCode(bankCode2);
						}
						...
						if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
							...
							&& !"".equals(((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeDebited().getBranchCode())) {
							String branchCode2 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeDebited().getBranchCode();
							accountToBeDebited.setBranchCode(branchCode2);
						}
						...
						if (((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice().get(i)))
							...
							// 3.1.7.1.6.4.1.1 Address
							String address8 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeDebited().getBranchInSpainAddress().getAddress();
							branchInSpainAddress2.setAddress(address8);

							// 3.1.7.1.6.4.1.2 PostCode
							String postCode9 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeDebited().getBranchInSpainAddress().getPostCode();
							branchInSpainAddress2.setPostCode(postCode9);

							// 3.1.7.1.6.4.1.3 Town
							String town8 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeDebited().getBranchInSpainAddress().getTown();
							branchInSpainAddress2.setTown(town8);

							// 3.1.7.1.6.4.1.4 Province
							String province8 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices()
								.getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeDebited().getBranchInSpainAddress().getProvince();
							branchInSpainAddress2.setProvince(province8);
							...
							// 3.1.7.1.6.4.2.2 PostCodeAndTown
							String postCodeAndTown9 = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
								.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
								.getAccountToBeDebited().getOverseasBranchAddress().getPostCodeAndTown();
							overseasBranchAddress2.setPostCodeAndTown(postCodeAndTown9);
					...
					// 3.1.7.1.7 CollectionAdditionalInformation
					if (!"".equals(((es.mityc.appfacturae.facturae321.InvoiceType) (facturae.getInvoices().getInvoice()
						.get(i))).getPaymentDetails().getInstallment().get(j).getCollectionAdditionalInformation())) {
						String collectionAdditionalInformation = ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
							.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j)
							.getCollectionAdditionalInformation();
						installment.setCollectionAdditionalInformation(collectionAdditionalInformation);
					}
					...
					// 3.1.7.1.8 RegulatoryReportingData
					if (!""
						.equals(((es.mityc.appfacturae.facturae321.InstallmentType) ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
							.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j))
							.getRegulatoryReportingData())) {
						String regulatoryReportingData = ((es.mityc.appfacturae.facturae321.InstallmentType) ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
							.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j))
							.getRegulatoryReportingData();
						installment.setRegulatoryReportingData(regulatoryReportingData);
					}
					...
					if (!""
						.equals(((es.mityc.appfacturae.facturae321.InstallmentType) ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
							.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j))
							.getDebitReconciliationReference())) {
						String debitReconciliationReference = ((es.mityc.appfacturae.facturae321.InstallmentType) ((es.mityc.appfacturae.facturae321.InvoiceType) (facturae
							.getInvoices().getInvoice().get(i))).getPaymentDetails().getInstallment().get(j))
							.getDebitReconciliationReference();
						installment.setDebitReconciliationReference(debitReconciliationReference);
					}
			...
			if (facturae.getInvoices().getInvoice().get(i).getLegalLiterals() != null
				&& facturae.getInvoices().getInvoice().get(i).getLegalLiterals().getLegalReference() != null) {
				es.mityc.facturae321.LegalLiteralsType legalLiterals = new es.mityc.facturae321.LegalLiteralsType();
				// 3.1.8.1 LegalReference
				String legalReference = null;
				// for 15
			...
			// 3.1.9 AdditionalData
			if (facturae.getInvoices().getInvoice().get(i).getAdditionalData() != null) {
				es.mityc.facturae321.AdditionalDataType additionalData = new es.mityc.facturae321.AdditionalDataType();
				...
				if (facturae.getInvoices().getInvoice().get(i).getAdditionalData().getRelatedDocuments() != null
					...
					&& facturae.getInvoices().getInvoice().get(i).getAdditionalData().getRelatedDocuments()
						.getAttachment().size() > 0) {
					es.mityc.facturae321.AttachedDocumentsType relatedDocuments = new es.mityc.facturae321.AttachedDocumentsType();
					// 3.1.9.2.1 Attachment
					es.mityc.facturae321.AttachmentType attachment = null;
					// for 16
					int attachmentCount = facturae.getInvoices().getInvoice().get(i).getAdditionalData()
						.getRelatedDocuments().getAttachment().size();
					for (int j = 0; j < attachmentCount; j++) {
						attachment = new es.mityc.facturae321.AttachmentType();

						// 3.1.9.2.1.1 AttachmentCompressionAlgorithm
						if (facturae.getInvoices().getInvoice().get(i).getAdditionalData().getRelatedDocuments()
							.getAttachment().get(j).getAttachmentCompressionAlgorithm() != null) {
							es.mityc.facturae321.AttachmentCompressionAlgorithmType attachmentCompressionAlgorithm = es.mityc.facturae321.AttachmentCompressionAlgorithmType
								.fromValue(facturae.getInvoices().getInvoice().get(i).getAdditionalData()
									.getRelatedDocuments().getAttachment().get(j).getAttachmentCompressionAlgorithm()
									.value());
							attachment.setAttachmentCompressionAlgorithm(attachmentCompressionAlgorithm);
						...
						// 3.1.9.2.1.2 AttachmentFormat
						es.mityc.facturae321.AttachmentFormatType attachmentFormat = es.mityc.facturae321.AttachmentFormatType
							.fromValue(facturae.getInvoices().getInvoice().get(i).getAdditionalData()
								.getRelatedDocuments().getAttachment().get(j).getAttachmentFormat().value());
						attachment.setAttachmentFormat(attachmentFormat);
						...
						if (facturae.getInvoices().getInvoice().get(i).getAdditionalData().getRelatedDocuments()
							.getAttachment().get(j).getAttachmentEncoding() != null) {
							es.mityc.facturae321.AttachmentEncodingType attachmentEncoding = es.mityc.facturae321.AttachmentEncodingType
								.fromValue(facturae.getInvoices().getInvoice().get(i).getAdditionalData()
									.getRelatedDocuments().getAttachment().get(j).getAttachmentEncoding().value());
							attachment.setAttachmentEncoding(attachmentEncoding);
						}
				...
				if (facturae.getInvoices().getInvoice().get(i).getAdditionalData().getExtensions() != null
					&& facturae.getInvoices().getInvoice().get(i).getAdditionalData().getExtensions().getAny() != null
					&& facturae.getInvoices().getInvoice().get(i).getAdditionalData().getExtensions().getAny().size() > 0) {
					es.mityc.facturae321.ExtensionsType extensions2 = null;

					// 3.1.9.4.1 [any]
					int extensionsCount = facturae.getInvoices().getInvoice().get(i).getAdditionalData()
						.getExtensions().getAny().size();
					for (int k = 0; k < extensionsCount; k++) {
						extensions2 = new es.mityc.facturae321.ExtensionsType();
						extensions2.getAny().add(
							facturae.getInvoices().getInvoice().get(i).getAdditionalData().getExtensions().getAny()
								.get(k));
					}
		...
		invoice321.setInvoices(invoices);

		// 4 Extensions
		if (facturae.getExtensions() != null && facturae.getExtensions().getAny() != null
			&& facturae.getExtensions().getAny().size() > 0) {
			es.mityc.facturae321.ExtensionsType extensions3 = null;

			// 4.1 [any]
			int extensionsCount2 = facturae.getExtensions().getAny().size();
			for (int k = 0; k < extensionsCount2; k++) {
				extensions3 = new es.mityc.facturae321.ExtensionsType();
				extensions3.getAny().add(facturae.getExtensions().getAny().get(k));
			}

			invoice321.setExtensions(extensions3);
		}
